...
-- SUPER+M is left alone/unbound here on purpose - it's already used
-- by the SDDM greeter's own separate Hyprland session (its
-- autogenerated config maps it to "exit Hyprland" there). That's a
-- different session/config entirely and wouldn't actually conflict,
-- but keeping it free avoids the two meanings being confusing.
