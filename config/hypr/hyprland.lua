...
-- Border colors - dynamically generated by wallust from your current
-- wallpaper (see config/wallust/wallust.toml). Falls back to
-- config/hypr/colors.lua's checked-in defaults until wallust has run
-- at least once.
